...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Joueur.numero_chandail'
        db.add_column(u'ligue_joueur', 'numero_chandail',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Joueur.numero_chandail'
        db.delete_column(u'ligue_joueur', 'numero_chandail')
