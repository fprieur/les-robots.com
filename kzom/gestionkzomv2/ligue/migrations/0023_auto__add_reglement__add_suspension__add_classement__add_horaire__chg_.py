...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Reglement'
        db.create_table(u'ligue_reglement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'ligue', ['Reglement'])

        # Adding model 'Suspension'
        db.create_table(u'ligue_suspension', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'ligue', ['Suspension'])

        # Adding model 'Classement'
        db.create_table(u'ligue_classement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'ligue', ['Classement'])

        # Adding model 'Horaire'
        db.create_table(u'ligue_horaire', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'ligue', ['Horaire'])


        # Changing field 'But.temps'
        db.alter_column(u'ligue_but', 'temps', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):
        # Deleting model 'Reglement'
        db.delete_table(u'ligue_reglement')

        # Deleting model 'Suspension'
        db.delete_table(u'ligue_suspension')

        # Deleting model 'Classement'
        db.delete_table(u'ligue_classement')

        # Deleting model 'Horaire'
        db.delete_table(u'ligue_horaire')


        # Changing field 'But.temps'
        db.alter_column(u'ligue_but', 'temps', self.gf('django.db.models.fields.DateTimeField')(null=True))
