...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'ligue.equipejoueur': {
            'Meta': {'object_name': 'EquipeJoueur'},
            'equipe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ligue.Equipe']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joueur': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ligue.Joueur']"})
        },
        u'ligue.joueur': {
