...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Joueur.saison'
        db.add_column('ligue_joueur', 'saison',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='saisonequipe', null=True, to=orm['ligue.Saison']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Joueur.saison'
        db.delete_column('ligue_joueur', 'saison_id')
    ...
    models = {
        ...
        'ligue.joueur': {
            ...
            'saison': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'saisonequipe'", 'null': 'True', 'to': "orm['ligue.Saison']"})
        },
        'ligue.partie': {
