...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'But.equipe'
        db.add_column(u'ligue_but', 'equipe',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='equipe_but', null=True, to=orm['ligue.Equipe']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'But.equipe'
        db.delete_column(u'ligue_but', 'equipe_id')
