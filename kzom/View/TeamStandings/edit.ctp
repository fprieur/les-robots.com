...
<?php echo $this->Form->create('TeamStanding');?>
	<fieldset>
		<legend><?php echo __('Edit Team Standing'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TeamStanding.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TeamStanding.id'))); ?></li>
