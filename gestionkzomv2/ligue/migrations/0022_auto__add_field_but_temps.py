...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'But.temps'
        db.add_column(u'ligue_but', 'temps',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'But.temps'
        db.delete_column(u'ligue_but', 'temps')
    ...
    models = {
        u'ligue.but': {
            ...
            'temps': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
        u'ligue.division': {
